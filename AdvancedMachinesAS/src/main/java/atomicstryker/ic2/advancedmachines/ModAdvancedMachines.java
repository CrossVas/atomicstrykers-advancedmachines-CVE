...
public class ModAdvancedMachines implements IGuiHandler, IProxy {
	...
	public void preInit(FMLPreInitializationEvent evt) {
		...
		maxMachineSpeedUpFactor = config.get(Configuration.CATEGORY_GENERAL, "maxMachineSpeedUpFactor", 10,
				"Advanced Machines will reach X times the speed of normal machines").getInt(10);
		maxMachineSpeedUpTicks = config.get(Configuration.CATEGORY_GENERAL, "maxMachineSpeedUpTicks", 10000,
				"Advanced Machines will take X ingame ticks to reach max speed").getInt(10000);
		machinePowerDrawFactor = config.get(Configuration.CATEGORY_GENERAL, "machinePowerDrawFactor", 3.0d,
				"Advanced Machines will draw X times the normal machines power").getDouble(3.0d);
	}
	...
	public void afterModsLoaded(FMLPostInitializationEvent evt) {
		if (config.get(Configuration.CATEGORY_GENERAL, "Rotary Macerator Enabled", true).getBoolean(true)) {
			GameRegistry.addRecipe(stackRotaryMacerator,
					new Object[] { "CRC", "PMP", "PAP", Character.valueOf('C'), IC2Items.getItem("coil"),
							Character.valueOf('R'), IC2Items.getItem("elemotor"), Character.valueOf('P'),
							IC2Items.getItem("plateiron"), Character.valueOf('M'), IC2Items.getItem("macerator"),
		...
		if (config.get(Configuration.CATEGORY_GENERAL, "Singularity Compressor Enabled", true).getBoolean(true)) {
			GameRegistry.addRecipe(stackSingularityCompressor,
					new Object[] { "RGR", "MMM", "PAP", Character.valueOf('R'), Blocks.obsidian, Character.valueOf('G'),
							IC2Items.getItem("reinforcedGlass"), Character.valueOf('P'), IC2Items.getItem("plateiron"),
		...
		if (config.get(Configuration.CATEGORY_GENERAL, "Centrifuge Extractor Enabled", true).getBoolean(true)) {
			GameRegistry.addRecipe(stackCentrifugeExtractor,
					new Object[] { "CEC", "RMR", "PAP", Character.valueOf('C'), IC2Items.getItem("coil"),
							...
							IC2Items.getItem("electrolyzedWaterCell"), Character.valueOf('P'),
							IC2Items.getItem("plateiron"), Character.valueOf('M'), IC2Items.getItem("extractor"),
							Character.valueOf('A'), IC2Items.getItem("advancedMachine") });
		}
		...
		if (config.get(Configuration.CATEGORY_GENERAL, "Combined Recycler Enabled", true).getBoolean(true)) {
			GameRegistry.addRecipe(stackCombinedRecycler,
					new Object[] { " M ", "PEP", "PRP", Character.valueOf('M'), stackRotaryMacerator,
							Character.valueOf('E'), stackCentrifugeExtractor, Character.valueOf('P'),
							IC2Items.getItem("plateiron"), Character.valueOf('R'), IC2Items.getItem("recycler") });
		}
		...
		if (config.get(Configuration.CATEGORY_GENERAL, "Rotary Ore Washer Enabled", true).getBoolean(true)) {
			GameRegistry.addRecipe(stackRotaryOreWasher,
					new Object[] { "CRC", "PWP", "PAP", Character.valueOf('C'), IC2Items.getItem("coil"),
							Character.valueOf('R'), IC2Items.getItem("elemotor"), Character.valueOf('P'),
							IC2Items.getItem("plateiron"), Character.valueOf('W'), IC2Items.getItem("orewashingplant"),
							Character.valueOf('A'), IC2Items.getItem("advancedMachine") });
		}
